...
<body>
    <div class="app-container">
        <div class="app-left" style="margin-left:-10px">
          ...
          <div class="app-logo">
            ...
            <span>Witaj  "<?php echo $name?>"</span>
          </div>
          <ul class="nav-list">
            <li class="nav-list-item " id="1">
              <a class="nav-list-link" href="<?php echo $url?>admin/index.php">
            ...
            <li class="nav-list-item" id="2">
              <a class="nav-list-link" href="<?php echo $url?>admin/wspolprace.php">
            ...
            <li class="nav-list-item " id="3">
              <a class="nav-list-link" href="<?php echo $url?>admin/blog.php">
            ...
            <li class="nav-list-item " id="4">
              <a class="nav-list-link" href="<?php echo $url?>admin/team.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                Zespół
              </a>
            </li>
            <li class="nav-list-item " id="5">
              <a class="nav-list-link" href="<?php echo $url?>admin/settings.php">
            ...
            <li class="nav-list-item " id="5">
              <a class="nav-list-link" href="<?php echo $url?>logout/index.php">
                 Wyloguj się
              </a>
            </li>
          </ul>
